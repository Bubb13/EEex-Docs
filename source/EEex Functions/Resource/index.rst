...
.. _EEex_Resource_GetStoreItemsIterator:

EEex_Resource_GetStoreItemsIterator
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. admonition:: Summary
   ...
   Returns an iterator that traverses the ``CStoreFileItem`` entries pointed to by ``storeHeader``.
...
| **Name**    | **Type**         | **Default Value** | **Description**                                             |
+=============+==================+===================+=============================================================+
| storeHeader | CStoreFileHeader |                   | The header of the .STO file whose items are to be iterated. |
+-------------+------------------+-------------------+-------------------------------------------------------------+
...
| **Type**                     | **Description** |
+==============================+=================+
| function() -> CStoreFileItem | See summary.    |
+------------------------------+-----------------+
