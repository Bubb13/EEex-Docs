...
.. _EEex_Sprite_GetAllSelected:

EEex_Sprite_GetAllSelected
^^^^^^^^^^^^^^^^^^^^^^^^^^


.. admonition:: Summary

   Returns a table populated with all the sprites the player currently has selected and is controlling.
