...
.. admonition:: Summary
   ...
   If it exists, sets the option with the given ``id`` to ``value``.
...
| **Name** | **Type**      | **Default Value** | **Description**                                                                   |
+==========+===============+===================+===================================================================================+
| id       | string        |                   | The id of the option whose value is to be set.                                    |
+----------+---------------+-------------------+-----------------------------------------------------------------------------------+
| value    | ``<non-nil>`` |                   | The value to set the option to. If ``nil``, sets the option to its default value. |
+----------+---------------+-------------------+-----------------------------------------------------------------------------------+
...
| **Type**  | **Description**                                                      |
+===========+======================================================================+
| ``<any>`` | The new value of the option, or ``nil`` if the option did not exist. |
+-----------+----------------------------------------------------------------------+
