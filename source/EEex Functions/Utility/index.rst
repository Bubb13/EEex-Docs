...
.. _EEex_Utility_GetMicroseconds:

EEex_Utility_GetMicroseconds
^^^^^^^^^^^^^^^^^^^^^^^^^^^^


.. admonition:: Summary

   Returns the number of microseconds that have elapsed since EEex's initialization.
...
.. _EEex_Utility_TryCatch:

EEex_Utility_TryCatch
^^^^^^^^^^^^^^^^^^^^^
...
.. _EEex_Utility_TryIgnore:

EEex_Utility_TryIgnore
^^^^^^^^^^^^^^^^^^^^^^
