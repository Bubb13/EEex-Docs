.. _CGameEffectAlignmentReversal Class:
...
.. _CGameEffectAlignmentReversal_Methods:
...
| **Name**                                                                            | **Description**                        |
+-------------------------------------------------------------------------------------+----------------------------------------+
| :ref:`CGameEffectAlignmentReversal\:\:Reverse<CGameEffectAlignmentReversalReverse>` | Reverse the alignment of the character |
+-------------------------------------------------------------------------------------+----------------------------------------+


----

.. _CGameEffectAlignmentReversalReverse:
