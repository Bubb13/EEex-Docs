...
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| :ref:`CStringList\:\:CNode<CStringList::CNode>`\* **CStringList\:\:NewNode**\(:ref:`CStringList\:\:CNode<CStringList::CNode>`\* pPrev, :ref:`CStringList\:\:CNode<CStringList::CNode>`\* pNext)  |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
* :ref:`CStringList\:\:CNode<CStringList::CNode>`\* *pPrev* - pointer to previous node
* :ref:`CStringList\:\:CNode<CStringList::CNode>`\* *pNext* - pointer to next node

**Return Value**

Returns :ref:`CStringList\:\:CNode<CStringList::CNode>`\*
