...
+-------------------------------------------------------------------------------------------------------------------------------------------------+
| :ref:`CMapStringToString\:\:CAssoc<CMapStringToString::CAssoc>`\* **CMapStringToString\:\:GetAssocAt**\(const char\* key, unsigned int\& nHash) |
+-------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-------------------------------------------------------------------------------------------------------------------------------------------------+
| :ref:`CMapStringToString\:\:CAssoc<CMapStringToString::CAssoc>`\* **CMapStringToString\:\:NewAssoc**\()                                         |
+-------------------------------------------------------------------------------------------------------------------------------------------------+
...
Returns :ref:`CMapStringToString\:\:CAssoc<CMapStringToString::CAssoc>`\*
